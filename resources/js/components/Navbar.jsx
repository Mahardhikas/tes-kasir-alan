    ...
    return (
        ...
        <div role="tablist" className="bg-base-100 shadow-sm tabs tabs-border">
            ...
            <Link 
                role="tab"
                href="/" 
                className={`btn rounded-none btn-ghost text-sm ${isActive('/') && url === '/' ? 'border-b-4 border-b-blue-500 text-blue-500 font-bold tab-active' : 'text-black'}`}
            >
            Transaksi</Link>
        </div>
        </>
